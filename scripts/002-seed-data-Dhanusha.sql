...
('admin', 'ADMIN001', 'admin123', 'Arjun Kumar'),
('admin', 'ADMIN002', 'admin123', 'Priya Sharma');

-- Shop owners
INSERT INTO users (role, login_id, password_hash, name) VALUES
('shop_owner', 'SHOP001', 'shop123', 'Dhanusha'),
('shop_owner', 'SHOP002', 'shop123', 'Dhanusha'),
('shop_owner', 'SHOP003', 'shop123', 'Ashwin');

-- Consumer users
INSERT INTO users (role, login_id, password_hash, name) VALUES
('consumer', 'RC-DL-2024-001', 'user123', 'Dhanu'),
('consumer', 'RC-DL-2024-002', 'user123', 'Ashween'),
...
(6, 'RC-DL-2024-001', 'BPL', 'Dhaarani', 4, '23, Patel Nagar, New Delhi', '9876543210', '123456789012', 1, '2026-03-01'),
(7, 'RC-DL-2024-002', 'APL', 'Ashween', 3, '56, Karol Bagh, New Delhi', '9876543211', '234567890123', 1, '2026-03-01'),
...
-- Queue bookings
INSERT INTO queue_bookings (consumer_id, shop_id, booking_date, qr_code, status) VALUES
(1, 1, '2026-03-01', 'Q-20260301-1-SAMPLE', 'booked'),
(2, 1, '2026-03-01', 'Q-20260301-2-SAMPLE', 'booked'),
(5, 3, '2026-03-05', 'Q-20260305-5-SAMPLE', 'booked');
