        ...
        {(Object.entries(roleConfig) as [UserRole, typeof roleConfig.consumer][]).map(([role, config]) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-2 rounded-lg border-2 p-5 text-center transition-all ${selectedRole === role
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 z-10 text-muted-foreground hover:text-foreground focus:outline-none"
                  >
