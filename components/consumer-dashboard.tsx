          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div>
              ...
              <div className="mt-4 p-3 bg-muted rounded-lg border border-border">
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Booking ID / Unique Code</p>
                <p className="text-lg font-mono font-bold text-primary">
                  {booking.qr_code}
                </p>
              </div>
              <p className="mt-4 text-sm text-muted-foreground max-w-sm">
                Please show this QR code or unique Booking ID at the fair price shop to collect your ration.
              </p>
            </div>
          </div>
        ) : (
